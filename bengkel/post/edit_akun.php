...
<html lang="en">
  <?php
    ...
    $extract_x = mysqli_query($con, "SELECT * FROM data_bengkel WHERE id_account like $_SESSION[id_bengkel_view_log]");
    $data_x = (mysqli_fetch_array($extract_x));

    $extract_v = mysqli_query($con, "SELECT * FROM account WHERE id_account like $_SESSION[id_bengkel_view_log]");
