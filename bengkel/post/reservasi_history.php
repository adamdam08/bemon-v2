...
<head>
  ...
  <div class="container ">
    ...
    <div class="form-group has-search">
        ...
        <input id="box-search" type="text" class="form-control" onkeyup="liveSearch()" placeholder="Kata Kunci Pencarian : NOPOL">
    </div>
    
    <table id="search-data" class="table table-hover bg-light rounded table-responsive-md" valign="center">
  <thead>
    <tr>
  ...
  <?php
      //Tampilkan Request 
      $mysql = mysqli_query($con,"SELECT * FROM data_reservasi where id_bengkel = '$id' ");
      if (!$mysql) {
        printf("Error: %s\n", mysqli_error($con));
        exit();
    }
