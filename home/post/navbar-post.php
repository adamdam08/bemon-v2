        ...
        <div class="container ">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent" style="overflow:hidden;">
            <ul class="nav navbar-nav mx-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="../home/post/riwayat.php">Riwayat Reservasi</a></li>
              <li class="nav-item"><a class="nav-link" href="../home/post/edit_akun.php">Akun Anda</a></li>
            </ul>
            <?php $_SESSION['kode_logout'] = '0'?>
